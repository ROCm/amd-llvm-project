/*===-- __clang_hip_complex_builtins - HIP impls of runtime complex fns ---===
 *
...
#ifndef __CLANG_HIP_COMPLEX_BUILTINS
#define __CLANG_HIP_COMPLEX_BUILTINS

// This header defines __muldc3, __mulsc3, __divdc3, and __divsc3.  These are
// libgcc functions that clang assumes are available when compiling c99 complex
// operations.  (These implementations come from libc++, and have been modified
// to work with HIP and OpenMP target offloading [in C and C++ mode].)
...
#endif // __CLANG_HIP_COMPLEX_BUILTINS
