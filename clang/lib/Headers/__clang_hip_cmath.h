...
#else
#define __RETURN_TYPE unsigned int
#endif
...
#else
#define __DEVICE__ static __attribute__((nothrow))
...
__DEVICE_NOCE__ inline int min(int __arg1, int __arg2) {
  return (__arg1 < __arg2) ? __arg1 : __arg2;
}
__DEVICE_NOCE__ inline int max(int __arg1, int __arg2) {
  return (__arg1 > __arg2) ? __arg1 : __arg2;
}
