...
__device__ __attribute__((const)) __device__ float __ocml_fmod_f32(float,
                                                                   float);
__device__ float __ocml_frexp_f32(float, __private int *);
...
__device__ float __ocml_modf_f32(float, __private float *);
...
__device__ float __ocml_remquo_f32(float, float, __private int *);
...
__device__ float __ocml_sincos_f32(float, __private float *);
__device__ float __ocml_sincospi_f32(float, __private float *);
...
__device__ double __ocml_frexp_f64(double, __private int *);
...
__device__ double __ocml_modf_f64(double, __private double *);
...
__device__ double __ocml_remquo_f64(double, double, __private int *);
...
__device__ double __ocml_sincos_f64(double, __private double *);
__device__ double __ocml_sincospi_f64(double, __private double *);
